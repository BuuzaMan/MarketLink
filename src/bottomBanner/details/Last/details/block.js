...
const Block = () => {
  return (
    <div className='flex flex-col desktop:w-[592px] mobile:w-[346px] desktop:h-[564px] mobile:h-[780px] desktop:order-2 tablet:order-2 mobile:order-1'>
        <div className='font-medium desktop:w-[553px] mobile:w-[346px] desktop:h-[144px] mobile:h-[200px] desktop:text-[48px] mobile:text-[40px] leading-[3rem] -tracking-[.06em] w-[553px] h-[144px] mobile:text-center'>
            <div>Фулфилмент,</div>  
            <div>который создан</div>
            <div>селлерами для селлеров</div>
        </div>
        <div className='desktop:w-[592px] desktop:h-[224px] mobile:w-[346px] mobile:h-[321px] desktop:mt-[13px] rounded-[10.266px] shadow-[0_3px_6.7px_4px_rgba(7,22,61,0.05);]'> 
