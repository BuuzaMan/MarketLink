...
const Cargo = () => {
  return (
    <div className='flex flex-col desktop:w-[1208px] desktop:h-[923px] mobile:w-[386px] mobile:h-[1100px] items-center desktop:mt-[120px] mobile:mt-[80px]'>
        ...
        <div className='flex desktop:flex-row mobile:flex-col desktop:w-[1208px] mobile:w-[386px] desktop:h-[756px] mobile:h-[950px] desktop:mt-[40px] mobile:mt-[40px] desktop:gap-x-6 mobile:gap-y-5 mobile:items-center'>
            <Delivery />
            <DeliveryCalc />
        </div>
    </div>
