...
const Cargo = () => {
  return (
    <div className='flex flex-col w-[1208px] items-center'>
        <div className='font-sfpro w-[1110px] font-medium text-[64px] leading-[3rem] -tracking-[.03em] text-center mt-[120px]'>
